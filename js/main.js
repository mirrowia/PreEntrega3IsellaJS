...
function fillList() {
  ...
  usuario.profilePicture = "https://static.wikia.nocookie.net/metalgear/images/e/e9/SnakeI15.png/revision/latest?cb=20160722234931&path-prefix=es"
  ...
  usuario.profilePicture = "https://sm.ign.com/t/ign_es/gallery/d/death-stra/death-stranding-every-confirmed-character-so-far_skpd.960.jpg"
  listaUsuario.push(usuario);
  ...
  usuario.profilePicture = "https://i.pinimg.com/564x/b1/b2/cb/b1b2cb1fa43c79e52a86e51c448ac04e.jpg"
  listaUsuario.push(usuario);
  ...
  usuario.profilePicture = "https://i.pinimg.com/564x/40/58/fc/4058fc497b784fe0fd906ca36397c276.jpg"
  listaUsuario.push(usuario);
}
...
function deleteUser(id) {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      Swal.fire("¡Eliminado!", "El usuario ha sido eliminado.", "Exito");
      listaUsuario.forEach((usuario) => {
        if (usuario.id == id) {
...
function modifyUser(id) {
  ...
  userFrame.className = "container mb-3 p-5";
  ...
  userImg.setAttribute("width", "350");
...
function saveInfo(id) {
  ...
  if (pwInput.value !== "" || pw2Input.value !== "") {
    if (pwInput.value !== "" && pw2Input.value !== "") {
      ...
      document.getElementById("userFrame").remove();
      createListFrame();
    } else {
...
function createLogin() {
  ...
  loginFrame.className = "d-flex flex-column mb-3 p-5";
...
function createRegister() {
  ...
  registerFrame.className = "d-flex flex-column mb-3 p-5";
...
function createListFrame() {
  ...
  const loggedUserdiv = createElement("loggedUser", "div");
  ...
  loggedUserdiv.className = "d-flex justify-content-end fs-3 text";
  listFrame.appendChild(userListFrame);

  loggedUserdiv .appendChild(loggedUserInfo);
  loggedUserInfo.innerHTML = "Hola " + loggedUser.apellido + ", " + loggedUser.nombre + "";
  loggedUserInfo.className = "d-flex justify-content-end fs-3 text mx-2";
  loggedUserdiv .appendChild(loggedUserBtn);
  loggedUserBtn.innerHTML = "Cerrar sesión";
  loggedUserBtn.className = "btn btn-danger ml-2";
